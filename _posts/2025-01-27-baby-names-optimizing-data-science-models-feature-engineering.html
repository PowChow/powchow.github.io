...
Just as baby name articles are mandatory reading for soon-to-be parents, the U.S. Social Security’s (SSA’s) Baby Names dataset should be required for budding data scientists. The dataset can be sliced and diced in many different ways, including language, time-based methods, and fodder for creative questions. It’s a healthy frequency-based dataset with a very long timeline. For example, website analytics tools count the number of visits by unique users, retail point-of-sale systems count products sold by color, and banks track the number of loans defaulted in a month. This article is a feature engineering tutorial on frequency datasets. The goal of feature engineering is to distill characteristics of each name and then find relationships between name trends over time using peak analysis techniques.

### Example of the Outcomes for Names:

<p align="center">
  <img src="/img/baby_names_bertha_line.jpg" alt="Bertha Name Peak Analysis Line" width="45%" />
  <img src="/img/baby_names_jenny_line.jpg" alt="Jenny Name Peak Analysis Line" width="45%" />
</p>

I started exploring names to find options. As a starting point, I assumed that trends over time captured inherent qualities and societal attitudes of parents choosing certain names. Baby name trends are able to explain a lot about societal preferences—see *Cross-Correlations of Baby Names* [NCBI Article](https://pmc.ncbi.nlm.nih.gov/articles/PMC4491744/). Also, when you know someone’s name, you likely know that person’s age—see *How to Tell Someone’s Age When All You Know Is Her Name* [FiveThirtyEight](https://fivethirtyeight.com/features/how-to-tell-someones-age-when-all-you-know-is-her-name/).

My own self-ish question about names: What U.S. names are most similar to my own old-timey name, Pauline?

See the steps I took in the original article, published on [Towards Data Science](https://medium.com/towards-data-science/optimize-data-science-models-with-feature-engineering-cluster-analysis-metrics-development-and-4be15489667a), and the code on [Kaggle](https://www.kaggle.com/code/paulinechow/baby-names-optimize-w-feature-engineering).
